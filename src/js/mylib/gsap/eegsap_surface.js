...
//    let eff_classs = document.querySelectorAll('.js-surface__up');
    let eff_classs = document.querySelectorAll('[data-jsanime="surface__up"]');
...
//----------------------------------------
{
    let eff_classs = document.querySelectorAll('[data-jsanime="surface__upgroup"]');
    eff_classs.forEach((target) => {
...
//----------------------------------------
{
    let eff_classs = document.querySelectorAll('[data-jsanime="surface__gather-center"]');
    eff_classs.forEach((target) => {
        let divs = target.querySelectorAll('div');
...
//----------------------------------------
{
    let eff_classs = document.querySelectorAll('[data-jsanime="surface__ltor"]');
    eff_classs.forEach((target) => {
        //let divs = target.querySelectorAll('div');
...
//----------------------------------------
{
    let eff_classs = document.querySelectorAll('[data-jsanime="surface__rtol"]');
    eff_classs.forEach((target) => {
        //let divs = target.querySelectorAll('div');
        gsap.fromTo(target, { autoAlpha: 0, rotate: 45, scale: 0.9, x: 1000 }, {
            x: 0,
...
//----------------------------------------
{
    let eff_classs = document.querySelectorAll('[data-jsanime="surface__gametext"]');
...
//----------------------------------------
{
    let eff_classs = document.querySelectorAll('[data-jsanime="surface__heroheading"]');
    eff_classs.forEach((target) => {
        let divs = target.querySelectorAll('div');
        console.log(divs);
...
//----------------------------------------
{
    let eff_classs = document.querySelectorAll('[data-jsanime="surface__heroheading2"]');
    eff_classs.forEach((target) => {
        let divs = target.querySelectorAll('div');
        //console.log(divs);
        ...
        gsap.set(divs[7], { opacity: 0, y: -40, rotate: 0 }); //  想像をカタチに
        const tl = gsap.timeline();
        //  指のサイズ
        let handSize = 3;
        //        if (checkUA() == isSP) {
        ...
        //  サイト作ります
            ...
            divs[6], { y: -15, duration: 1 },
        ).to(
            divs[6], { y: -80, opacity: 0, duration: 1 },
        //  想像を触れるカタチに。
        ).to(
            divs[7], { y: -40, duration: 1, opacity: 1 },
        ).to(
            //divs[7], { y: -15, backgroundColor: "#90ee90",padding :"0px 40px", duration: 1 },
            divs[7], { y: -50, backgroundColor: "rgba(144,238,144,0.8)",padding :"0px 40px", duration: 1 },
            //        ).to(
            //            divs[6], { y: -80, opacity: 0, duration: 1 },
        );
    });
